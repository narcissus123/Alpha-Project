...
export const UserImage = () => {
  return (
    <div class="relative mr-3 h-10 w-10 overflow-hidden rounded-full bg-gray-100">
      <svg
        class="absolute -left-1.5 h-12 w-12 text-gray-400 md:-left-1"
        fill="currentColor"
        viewBox="0 0 20 20"
        xmlns="http://www.w3.org/2000/svg"
      >
...
export const CourseImage = () => {
  return (
    <svg
      ...
      width="1em"
      xmlns="http://www.w3.org/2000/svg"
      class="m-auto  rounded-full bg-red-600 bg-cover"
    >
      <g>
...
export const CalendarIcon = () => {
  return (
    <div class="pointer-events-none pr-3">
      <svg
        ariaHidden="true"
...
export const NotifyImage = () => {
  return (
    <svg
      class="h-8 w-8 bg-white text-yellow-600"
      stroke="currentColor "
      fill="currentColor"
      strokeWidth="0"
      version="1.1"
...
export const AllCoursesImage = () => {
  return (
    <svg
      ...
      viewBox="0 0 512 512"
      xmlns="http://www.w3.org/2000/svg"
      class="w-4 text-white group-hover:text-customYellow sm:w-5 lg:w-6"
    >
...
export const LogoutImage = ({ Class }) => {
  return (
    <svg
      stroke="currentColor"
      fill="currentColor"
...
export const EditProfileImage = ({ Class }) => {
  return (
    <svg
      stroke="currentColor"
      fill="currentColor"
...
export const RegisteredCoursesImage = ({ Class }) => {
  return (
    <svg
      stroke="currentColor"
      fill="currentColor"
...
export const LeftArrowImage = ({ Class }) => {
  return (
    <svg
      stroke="currentColor"
      fill="currentColor"
...
export const RightArrowImage = ({ Class }) => {
  return (
    <svg
      stroke="currentColor"
      fill="currentColor"
...
export const InstructorImage2 = ({ Class }) => {
  return (
    <svg
      stroke="currentColor"
      fill="currentColor"
...
export const UserChatImage = ({ Class }) => {
  return (
    <svg
      stroke="currentColor"
      fill="currentColor"
...
export const DownArrow = ({ Class, setShow }) => {
  return (
    <svg
      fontSize="1.5rem"
      stroke="currentColor"
...
export const UpArrowImage = ({ Class, setShow }) => {
  return (
    <svg
      fontSize="1.5rem"
      stroke="currentColor"
...
export const InstagramImage = ({ Class }) => {
  return (
    <svg
      stroke="currentColor"
      fill="currentColor"
...
export const FacebookImage = ({ Class }) => {
  return (
    <svg
      stroke="currentColor"
      fill="currentColor"
...
export const WhatsappImage = ({ Class }) => {
  return (
    <svg
      stroke="currentColor"
      fill="currentColor"
...
export const TwitterImage = ({ Class }) => {
  return (
    <svg
      stroke="currentColor"
      fill="none"
...
export const SortingDownArrowImage = ({ Class }) => {
  return (
    <svg
      stroke="currentColor"
      fill="currentColor"
...
export const SortingUpArrowImage = ({ Class }) => {
  return (
    <svg
      stroke="currentColor"
      fill="currentColor"
...
export const CommentReplyImage = () => {
  return (
    <svg
      aria-hidden="true"
      class="mr-1 h-4 w-4"
...
export const AdminChatImage = ({ Class }) => {
  return (
    <svg
      stroke="currentColor"
      fill="currentColor"
...
export const VerifyCommentImage = () => {
  return (
    <svg
      stroke="currentColor"
      fill="currentColor"
...
export const ThreeDotMenuImage = () => {
  return (
    <svg
      class=" h-5 w-5"
      aria-hidden="true"
