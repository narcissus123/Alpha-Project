  ...
  return (
    <div class="relative right-0 top-28 h-[30rem] w-[30rem] rounded-full border lg:top-20 lg:h-[35rem] lg:w-[35rem]">
      <div class="absolute ml-8 mt-8 h-6/7 w-6/7 rounded-full border border-slate-400 lg:ml-10 lg:mt-10 ">
        <div class="relative left-1/2 bottom-2 h-3 w-3 animate-rotation rounded-full border bg-yellow-300 "></div>
      </div>
      ...
      <div class="absolute ml-16 mt-16 h-5/7 w-5/7 overflow-hidden rounded-full border bg-enrollImg bg-cover bg-no-repeat lg:ml-20 lg:mt-20 lg:border-slate-400">
        <img src={course.image} class="h-full object-cover" />
      </div>
    </div>
  );
};
